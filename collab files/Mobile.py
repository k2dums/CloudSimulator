...
class Mobile(DeviceNode):
    ...
    def drainBattery(self,time:float=1)  :
   ...
   #This sets the specification for the instnace of the mobile object (has extra battery parameter) 
    def setSpecification(self,processingPower=2000,ram=4,memory=500,downloadRate=100,uploadRate=100,batteryCapacity=4000) :
