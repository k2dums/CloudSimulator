...
class Broker:
    ...
    # def __init__(self,network,resourceList:list,layerno)  :
    #     self.__network=network
    #     self.__brokerId=Broker.__BROKER_ID
    #     self.__deviceId=0
    ...
    def assignLinearResources(self,device) :
    ...
    def assignResourcesChromosome(self,chromosome:Chromosome)  :
        assert isinstance(self.__network,Network)
